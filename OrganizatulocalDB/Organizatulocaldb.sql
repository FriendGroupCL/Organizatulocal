...
CREATE TABLE IF NOT EXISTS `organizatulocal_DB`.`producto_especial` (
  ...
  INDEX `fk_producto_especial_local1_idx` (`local_id` ASC),
  CONSTRAINT `fk_producto_especial_categoria1`
    FOREIGN KEY (`categoria_id`)
    REFERENCES `organizatulocal_DB`.`categoria` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_producto_especial_local1`
    FOREIGN KEY (`local_id`)
    REFERENCES `organizatulocal_DB`.`local` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `organizatulocal_DB`.`plan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `organizatulocal_DB`.`plan` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
  `descripcion` VARCHAR(300) NOT NULL,
...
-- -----------------------------------------------------
-- Table `organizatulocal_DB`.`local_has_plan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `organizatulocal_DB`.`local_has_plan` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `local_id` INT NOT NULL,
  `plan_id` INT NOT NULL,
  `fecha_inicio` DATE NOT NULL,
  `fecha_termino` DATE NOT NULL,
  INDEX `fk_local_has_plan_plan1_idx` (`plan_id` ASC),
  INDEX `fk_local_has_plan_local1_idx` (`local_id` ASC),
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_local_has_plan_local1`
    FOREIGN KEY (`local_id`)
    REFERENCES `organizatulocal_DB`.`local` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_local_has_plan_plan1`
    FOREIGN KEY (`plan_id`)
    REFERENCES `organizatulocal_DB`.`plan` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
