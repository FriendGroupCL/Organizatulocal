 ...
 */
@Stateless
public class VentaHasProductoEspecialFacade extends AbstractFacade<VentaHasProductoEspecial> {
    ...
    public VentaHasProductoEspecialFacade() {
        super(VentaHasProductoEspecial.class);
    }
