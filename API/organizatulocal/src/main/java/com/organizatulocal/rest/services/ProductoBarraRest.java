...
public class ProductoBarraRest {
    ...
    public void create(ProductoBarra producto_barra){
        ejbProductoBarraFacade.create(producto_barra);
    }
    
    @PUT
    @Consumes({MediaType.APPLICATION_JSON})
    @Path("{id}")
    public void edit(@PathParam("id")Integer id, ProductoBarra producto_barra){
        ejbProductoBarraFacade.edit(producto_barra);
    }
    ...
    public void remove(@PathParam("id")Integer id){
        ejbProductoBarraFacade.remove(ejbProductoBarraFacade.find(id));
    }*/
