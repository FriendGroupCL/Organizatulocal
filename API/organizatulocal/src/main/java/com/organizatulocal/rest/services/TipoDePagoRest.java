...
public class TipoDePagoRest {
    ...
    public void create(TipoDePago tipo_de_pago){
        ejbTipoDePagoFacade.create(tipo_de_pago);
    }
    
    @PUT
    @Consumes({MediaType.APPLICATION_JSON})
    @Path("{id}")
    public void edit(@PathParam("id")Integer id, TipoDePago tipo_de_pago){
        ejbTipoDePagoFacade.edit(tipo_de_pago);
    }
    ...
    public void remove(@PathParam("id")Integer id){
        ejbTipoDePagoFacade.remove(ejbTipoDePagoFacade.find(id));
    }*/
